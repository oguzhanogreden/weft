...
const recipes = [
  ...
  },
  {
    ...
    description: "Stream-based style updates, object form styles, and theme switching patterns",
  },
  {
    slug: "async-data-loading",
    name: "Async Data Loading",
    description: "Effect-returning components with loading states and error handling",
  },
  {
    slug: "form-handling",
    name: "Form Handling",
    description: "Stream-based inputs, reactive validation, and Effect-powered submit handlers",
  },
  {
    slug: "list-rendering",
    name: "List Rendering",
    description: "Fragment usage, array mapping, and dynamic lists from streams",
  },
  {
...
const App = () => (
  <div>
    ...
    <p class="subtitle">Interactive examples demonstrating effect-ui patterns</p>
